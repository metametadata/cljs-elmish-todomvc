 ...
 */
frontend.ui.connect = (function frontend$ui$connect(p__92555,view_model,view,control,reconcile){
var vec__92558 = p__92555;
var model = cljs.core.nth.call(null,vec__92558,(0),null);
var signal = cljs.core.nth.call(null,vec__92558,(1),null);
var _initial_ = vec__92558;
var model_atom = reagent.core.atom.call(null,model);
var dispatch_action = ((function (model_atom,vec__92558,model,signal,_initial_){
return (function (a){
cljs.core.swap_BANG_.call(null,model_atom,reconcile,a);

return null;
});})(model_atom,vec__92558,model,signal,_initial_))
;
var dispatch_signal = ((function (model_atom,dispatch_action,vec__92558,model,signal,_initial_){
return (function (s){
control.call(null,cljs.core.deref.call(null,model_atom),s,dispatch_action);

return null;
});})(model_atom,dispatch_action,vec__92558,model,signal,_initial_))
;
var connected_view = ((function (model_atom,dispatch_action,dispatch_signal,vec__92558,model,signal,_initial_){
return (function (){
...
});})(model_atom,dispatch_action,dispatch_signal,vec__92558,model,signal,_initial_))
;
var G__92559_92560 = signal;
var G__92559_92561__$1 = (((G__92559_92560 == null))?null:dispatch_signal.call(null,G__92559_92560));
...
//# sourceMappingURL=ui.js.map?rel=1448310492298