 ...
 */
frontend.ui.connect_reactive_reagent = (function frontend$ui$connect_reactive_reagent(p__22746,init_args){
...
var _spec_ = map__22749__$1;
var init = cljs.core.get.call(null,map__22749__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var view_model = cljs.core.get.call(null,map__22749__$1,new cljs.core.Keyword(null,"view-model","view-model",-895405675));
var view = cljs.core.get.call(null,map__22749__$1,new cljs.core.Keyword(null,"view","view",1247994814));
var control = cljs.core.get.call(null,map__22749__$1,new cljs.core.Keyword(null,"control","control",1892578036));
var reconcile = cljs.core.get.call(null,map__22749__$1,new cljs.core.Keyword(null,"reconcile","reconcile",-728661830));
var model = cljs.core.apply.call(null,init,init_args);
var model_ratom = reagent.core.atom.call(null,model);
var dispatch_action = ((function (model,model_ratom,map__22749,map__22749__$1,_spec_,init,view_model,view,control,reconcile){
...
});})(model,model_ratom,map__22749,map__22749__$1,_spec_,init,view_model,view,control,reconcile))
;
var dispatch_signal = ((function (model,model_ratom,map__22749,map__22749__$1,_spec_,init,view_model,view,control,reconcile){
...
;
var reagent_view = ((function (model,model_ratom,map__22749,map__22749__$1,_spec_,init,view_model,view,control,reconcile){
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__17523__auto__ = (function frontend$ui$track_keys_$_iter__22755(s__22756){
...
var c__17521__auto__ = cljs.core.chunk_first.call(null,s__22756__$2);
var size__17522__auto__ = cljs.core.count.call(null,c__17521__auto__);
var b__22758 = cljs.core.chunk_buffer.call(null,size__17522__auto__);
if((function (){var i__22757 = (0);
while(true){
if((i__22757 < size__17522__auto__)){
var key = cljs.core._nth.call(null,c__17521__auto__,i__22757);
cljs.core.chunk_append.call(null,b__22758,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [key,reagent.ratom.make_reaction.call(null,((function (i__22757,key,c__17521__auto__,size__17522__auto__,b__22758,s__22756__$2,temp__4425__auto__){
return (function (){
return cljs.core.get.call(null,cljs.core.deref.call(null,map_ratom),key);
});})(i__22757,key,c__17521__auto__,size__17522__auto__,b__22758,s__22756__$2,temp__4425__auto__))
)], null));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__22758),frontend$ui$track_keys_$_iter__22755.call(null,cljs.core.chunk_rest.call(null,s__22756__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__22758),null);
}
} else {
var key = cljs.core.first.call(null,s__22756__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [key,reagent.ratom.make_reaction.call(null,((function (key,s__22756__$2,temp__4425__auto__){
return (function (){
return cljs.core.get.call(null,cljs.core.deref.call(null,map_ratom),key);
});})(key,s__22756__$2,temp__4425__auto__))
)], null),frontend$ui$track_keys_$_iter__22755.call(null,cljs.core.rest.call(null,s__22756__$2)));
}
} else {
return null;
}
...
var args22762 = [];
var len__17809__auto___22765 = arguments.length;
var i__17810__auto___22766 = (0);
while(true){
if((i__17810__auto___22766 < len__17809__auto___22765)){
args22762.push((arguments[i__17810__auto___22766]));

var G__22767 = (i__17810__auto___22766 + (1));
i__17810__auto___22766 = G__22767;
continue;
} else {
}
break;
...
return cljs.core.update.call(null,cljs.core.update.call(null,spec,new cljs.core.Keyword(null,"control","control",1892578036),(function (p1__22760_SHARP_){
...
return p1__22760_SHARP_.call(null,model,signal,dispatch);
});
})),new cljs.core.Keyword(null,"reconcile","reconcile",-728661830),(function (p1__22761_SHARP_){
...
var result = p1__22761_SHARP_.call(null,model,action);
return result;
});
}));
});
...
//# sourceMappingURL=ui.js.map?rel=1452522514181