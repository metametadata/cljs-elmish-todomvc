...
frontend.core.history = (function (){var G__32827 = (new goog.history.Html5History());
G__32827.setEnabled(true);
...
var vec__32830 = frontend.todos.init.call(null);
var _ = cljs.core.nth.call(null,vec__32830,(0),null);
var todos_initial_signal = cljs.core.nth.call(null,vec__32830,(1),null);
var todos_initial = vec__32830;
...
var dispatch_navigate = ((function (storage,vec__32830,_,todos_initial_signal,todos_initial,app){
...
});})(storage,vec__32830,_,todos_initial_signal,todos_initial,app))
;
goog.events.removeAll(frontend.core.history);

goog.events.listen(frontend.core.history,goog.history.EventType.NAVIGATE,((function (storage,vec__32830,_,todos_initial_signal,todos_initial,app){
return (function (p1__32828_SHARP_){
return dispatch_navigate.call(null,p1__32828_SHARP_.token);
});})(storage,vec__32830,_,todos_initial_signal,todos_initial,app))
);
...
//# sourceMappingURL=core.js.map?rel=1448348247912