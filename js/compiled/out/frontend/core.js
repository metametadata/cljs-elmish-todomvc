...
frontend.core.history = (function (){var G__46314 = (new goog.history.Html5History());
G__46314.setEnabled(true);
...
var vec__46317 = frontend.todos.init.call(null);
var _ = cljs.core.nth.call(null,vec__46317,(0),null);
var todos_first_signal = cljs.core.nth.call(null,vec__46317,(1),null);
var todos_initial = vec__46317;
...
var dispatch_navigate = ((function (storage,vec__46317,_,todos_first_signal,todos_initial,app){
...
});})(storage,vec__46317,_,todos_first_signal,todos_initial,app))
;
goog.events.removeAll(frontend.core.history);

goog.events.listen(frontend.core.history,goog.history.EventType.NAVIGATE,((function (storage,vec__46317,_,todos_first_signal,todos_initial,app){
return (function (p1__46315_SHARP_){
return dispatch_navigate.call(null,p1__46315_SHARP_.token);
});})(storage,vec__46317,_,todos_first_signal,todos_initial,app))
);
...
//# sourceMappingURL=core.js.map?rel=1448243714448