...
frontend.core.history = (function (){var G__44929 = (new goog.history.Html5History());
G__44929.setEnabled(true);
...
var vec__44932 = frontend.todos.init.call(null);
var _ = cljs.core.nth.call(null,vec__44932,(0),null);
var todos_first_signal = cljs.core.nth.call(null,vec__44932,(1),null);
var todos_initial = vec__44932;
var app = frontend.devtools.connect.call(null,frontend.devtools.init.call(null,todos_initial),frontend.todos.view_model,frontend.todos.view,frontend.persistence_middleware.wrap_control.call(null,frontend.todos.control,todos_first_signal,storage,new cljs.core.Keyword(null,"model","model",331153215)),frontend.persistence_middleware.wrap_reconcile.call(null,frontend.todos.reconcile,storage,new cljs.core.Keyword(null,"model","model",331153215)));
var dispatch_navigate = ((function (storage,vec__44932,_,todos_first_signal,todos_initial,app){
...
});})(storage,vec__44932,_,todos_first_signal,todos_initial,app))
;
goog.events.removeAll(frontend.core.history);

goog.events.listen(frontend.core.history,goog.history.EventType.NAVIGATE,((function (storage,vec__44932,_,todos_first_signal,todos_initial,app){
return (function (p1__44930_SHARP_){
return dispatch_navigate.call(null,p1__44930_SHARP_.token);
});})(storage,vec__44932,_,todos_first_signal,todos_initial,app))
);
...
//# sourceMappingURL=core.js.map?rel=1448243075582