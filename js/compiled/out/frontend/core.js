...
frontend.core.history = (function (){var G__22747 = (new goog.history.Html5History());
G__22747.setEnabled(true);
...
var app = frontend.ui.connect_reagent.call(null,frontend.devtools.new_spec.call(null,frontend.persistence_middleware.wrap.call(null,frontend.todos.new_spec.call(null,frontend.core.history),storage,new cljs.core.Keyword(null,"model","model",331153215),null),storage,new cljs.core.Keyword(null,"devtools","devtools",-1870878518)));
...
return new cljs.core.Keyword(null,"dispatch-signal","dispatch-signal",205544591).cljs$core$IFn$_invoke$arity$1(app).call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"component","component",1555936782),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),p1__22748_SHARP_.token], null)], null));
});})(storage,app))
);
...
//# sourceMappingURL=core.js.map?rel=1448711661314