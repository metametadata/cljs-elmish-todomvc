...
frontend.core.history = (function (){var G__82997 = (new goog.history.Html5History());
G__82997.setEnabled(true);
...
var vec__83000 = frontend.todos.init.call(null);
var _ = cljs.core.nth.call(null,vec__83000,(0),null);
var todos_first_signal = cljs.core.nth.call(null,vec__83000,(1),null);
var todos_initial = vec__83000;
var app = frontend.devtools.connect.call(null,todos_initial,frontend.todos.view_model,frontend.todos.view,frontend.persistence_middleware.wrap_control.call(null,frontend.todos.control,todos_first_signal,storage,new cljs.core.Keyword(null,"model","model",331153215),null),frontend.persistence_middleware.wrap_reconcile.call(null,frontend.todos.reconcile,storage,new cljs.core.Keyword(null,"model","model",331153215),null),storage);
var dispatch_navigate = ((function (storage,vec__83000,_,todos_first_signal,todos_initial,app){
...
});})(storage,vec__83000,_,todos_first_signal,todos_initial,app))
;
goog.events.removeAll(frontend.core.history);

goog.events.listen(frontend.core.history,goog.history.EventType.NAVIGATE,((function (storage,vec__83000,_,todos_first_signal,todos_initial,app){
return (function (p1__82998_SHARP_){
return dispatch_navigate.call(null,p1__82998_SHARP_.token);
});})(storage,vec__83000,_,todos_first_signal,todos_initial,app))
);
...
//# sourceMappingURL=core.js.map?rel=1448293983996