...
frontend.core.history = (function (){var G__47106 = (new goog.history.Html5History());
G__47106.setEnabled(true);
...
var vec__47109 = frontend.todos.init.call(null);
var _ = cljs.core.nth.call(null,vec__47109,(0),null);
var todos_initial_signal = cljs.core.nth.call(null,vec__47109,(1),null);
var todos_initial = vec__47109;
...
goog.events.listen(frontend.core.history,goog.history.EventType.NAVIGATE,((function (storage,vec__47109,_,todos_initial_signal,todos_initial,app){
return (function (p1__47107_SHARP_){
return new cljs.core.Keyword(null,"dispatch-signal","dispatch-signal",205544591).cljs$core$IFn$_invoke$arity$1(app).call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"component","component",1555936782),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),p1__47107_SHARP_.token], null)], null));
});})(storage,vec__47109,_,todos_initial_signal,todos_initial,app))
);
...
//# sourceMappingURL=core.js.map?rel=1448472824376